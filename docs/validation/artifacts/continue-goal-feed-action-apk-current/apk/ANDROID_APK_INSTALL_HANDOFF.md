...
- Type: APK
- Path: `docs/validation/artifacts/continue-goal-feed-action-apk-current/apk/FREED-release-arm64.apk`
- Stable copy: `docs/validation/artifacts/continue-goal-feed-action-apk-current/apk/FREED-release-arm64.apk`
- Timestamped copy: `docs/validation/artifacts/continue-goal-feed-action-apk-current/apk/FREED-release-arm64-20260607-133105.apk`
- SHA-256: `e59acf32d767b1b980cb702bac4901bcad1ec1ecf1ddee773ed175bc3537e154`
- Size: 56.4 MB
- ABIs: arm64-v8a
...
```sh
npm run qa:android-install -- --apk docs/validation/artifacts/continue-goal-feed-action-apk-current/apk/FREED-release-arm64.apk --run-id android-install-20260607-134717 --output-dir docs/validation/artifacts/android-install-20260607-134717/android-install-qa
```
...
```sh
npm run evidence:android-real-browser -- --device <serial> --adult-url <real-adult-url> --permission-proof --native-status-proof --dns-guard-proof --run-id android-install-20260607-134717 --output-dir docs/validation/artifacts/android-install-20260607-134717/android-real-browser-capture
```
